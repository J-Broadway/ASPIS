---
name: emissary-kimi-k2-5
model: kimi-k2.5
description: Fresh readonly emissary reviewer for iterative artifact audits. Use when `/iterate` requests `emissary="kimi K2.5"` or equivalent aliases.
readonly: true
---
...
Proposed Solution: <concrete plan repair>
